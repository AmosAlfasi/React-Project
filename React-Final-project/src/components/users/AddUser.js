...
const AddUser = (props) => {
    ...
    const submitHandler = (e) => {
        e.preventDefault();
        setShow(false);
        props.onClosePopup({ status: false, newUser: { key: UUID.v4(), firstName, lastName, id, maritalSatus, birthday: `${birthDay}/${birthMonth}/${birthYear}`, costs: [] } });
    }
            ...
            <div className="add-user" >
                ...
                <Form>
                    ...
                    <Form.Group className="form-group">
                        ...
                        <Form.Select onChange={(e) => setMaritalSatus(e.target.value)}>
                    ...
                    <div className="birthday-container">
                        ...
                        <div className="birthday-fields">
                            ...
                            <Form.Group className="form-group">
                                ...
                                <Form.Select onChange={(e) => setBirthMonth(e.target.value)}>
                                    {days.map(d => <option value={d}>{d}</option>)}
                                </Form.Select>
                            </Form.Group>
                            <Form.Group className="form-group">
                                <Form.Label>Month:</Form.Label>
                                <Form.Select onChange={(e) => setBirthYear(e.target.value)}>
                                    {months.map(d => <option value={d}>{d}</option>)}
                                </Form.Select>
                            </Form.Group>
                            <Form.Group className="form-group">
                                <Form.Label>Year:</Form.Label>
                                <Form.Select onChange={(e) => setBirthDay(e.target.value)}>
